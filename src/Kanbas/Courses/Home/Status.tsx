...
import { AiFillHome } from "react-icons/ai"; // Home Page icon
import { FaChartBar } from "react-icons/fa"; // Course Analytics & Stream icon
import { FaBell } from "react-icons/fa"; // Notifications icon
import { MdAnnouncement } from "react-icons/md"; // New Announcement icon
